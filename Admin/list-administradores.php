                              ...
                              <tbody style="text-align: center;">
                                   ...
                                   ?>
                                             <tr>
                                                  ...
                                                  <td>
                                                       <a href="editar-administrador.php?editid=<?= $row['id']; ?>" class="btn btn-success" style="display: inline-block; margin-right: 5px;">Editar</a>
                                                       <form action="crud-administrador.php" method="POST" style="display: inline-block; margin: 0;">
                                                            <button type="submit" name="btn-eliminar" value="<?= $row['id']; ?>" class="btn btn-danger">Borrar</button>
                                                       </form>
                                                  </td>
                                             </tr>
     ...
     <div class="modal-dialog">
          <div class="modal-content">
               ...
               <div class="modal-body">
                    <form class="row g-3" method="post" action="crud-administrador.php" id="form-registrar">
                         <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                              ...
                              <input type="text" class="form-control" id="txt-apellido" placeholder="Ingresar apellido" name="apellido" required>
                         </div>
                         <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                              ...
                              <input type="password" class="form-control" id="txt-contraseña" placeholder="Ingresar contraseña" name="contraseña" required>
                         </div>
